...
public abstract class GuiList extends Component
{
    ...
    public GuiList(GuiControl parent, int width, int height, int left, int top, int screenWidth, int screenHeight)
    {
